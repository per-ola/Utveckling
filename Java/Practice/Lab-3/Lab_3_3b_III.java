...
public class Lab_3_3b_III
{
	public static void main(String[] args)
	{
		...
		System.out.println("Ange skala för planet samt värden på a, b och c");
		...
		if(k<0)
		{
			System.out.println("Ekvationen har inga reella rötter");
		}
		else
		...
		System.out.println("Lösningsvärdena faller inte inom angivna intervall");
